...
本地 fork 基于 `1624318455/dsh-plugin-tts` 提交 `ec0cf87ef52abb81ae91681a966aa3096365e631`，当前发布候选版为 `v0.1.8`。复用 Host/client 插件注册、assistant 消息按钮、Auto Read 开关、既有 Edge/RVC 链路、长文本播放、停止/暂停、主题与设置持久化。源码已推送到 `abbccdd/dsh-localtts`。
...
当前交付为可继续验收的仓库和 v0.1.8 发布候选版；尚未打稳定版 tag 或发布 npm 包，也不能声称全部用户验收要求已完成。
